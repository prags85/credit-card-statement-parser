...
Handles Kotak Bank specific PDF statement formats
"""
...
class KotakParser(BaseCreditCardParser):
    ...
    def extract_card_number(self, text: str) -> Optional[str]:
        """Extract last 4 digits of Kotak card number"""
        patterns = [
    ...
    def extract_billing_cycle(self, text: str) -> Tuple[Optional[str], Optional[str]]:
        """Extract Kotak billing cycle dates"""
        patterns = [
    ...
    def extract_due_date(self, text: str) -> Optional[str]:
        """Extract Kotak payment due date"""
        patterns = [
    ...
    def extract_amount_due(self, text: str) -> Optional[float]:
        """Extract Kotak total amount due"""
        patterns = [
    ...
    def extract_transactions(self, pdf_path: str) -> List[Dict]:
        """Extract Kotak transaction details"""
        transactions = []
        try:
            import tabula
