...
Handles SBI Card specific PDF statement formats
"""
...
class SBIParser(BaseCreditCardParser):
    ...
    def extract_card_number(self, text: str) -> Optional[str]:
        """Extract last 4 digits of SBI card number"""
        patterns = [
    ...
    def extract_billing_cycle(self, text: str) -> Tuple[Optional[str], Optional[str]]:
        """Extract SBI billing cycle dates"""
        patterns = [
    ...
    def extract_transactions(self, pdf_path: str) -> List[Dict]:
        """Extract SBI transaction details"""
        transactions = []
        try:
            import tabula
